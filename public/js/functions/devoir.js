$(function(){
    ...
    $(document).on('click', '[data-bs-target="#create-devoir-modal"]', function(e) {
        ...
        var coefficientIdInput = $('#devoirId');
        var form = $('#devoirForm');
        var button = $('#submit-devoir-form-button');
        var buttonDevoirSave = $('#submit-devoirSave-form-button');
        var buttonQuestionSave = $('#submit-questionSave-form-button');
        ...
        buttonDevoirSave.removeClass('btn-outline-primary btn-outline-success');
        buttonQuestionSave.removeClass('btn-outline-primary btn-outline-success');
        form.trigger('reset');
        ...
        if (action == "create") {
            ...
            buttonDevoirSave.addClass('btn-outline-primary');
            buttonQuestionSave.addClass('btn-outline-primary');
            button.children('span#submit-devoir-form-button-text').text('Enregistrer');
            headerText.text('Configurer un devoir');
        } else if (action == "edit") {
            header.addClass('bg-success');
            button.addClass('btn-outline-success');
            buttonDevoirSave.addClass('btn-outline-success');
            buttonQuestionSave.addClass('btn-outline-success');
            ...
            coefficientIdInput.val(devoirId);
            $.ajax({
    ...
    // When submiting form for updating or creating devoir
