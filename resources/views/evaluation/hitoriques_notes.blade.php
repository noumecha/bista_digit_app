<x-app-layout>
                        ...
                        <div class="pb-0 card-header">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-6">
                                    <h5 class="">Historique de modifications des notes</h5>
                                    <p class="text-sm">
                                        rapport de modifications des notes
                                    </p>
                                </div>
                            </div>
                            <form class="form form-inline row mt-3" id="filterHistoryForm">
                                <div class="col-md-6">
    ...
    @section('scripts')
        <script src="{{ asset('js/functions/histories.js') }}"></script>
    @endsection
</x-app-layout>
