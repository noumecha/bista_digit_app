            ...
            <div class="mt-4 row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive" id="devoirsTable">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date_debut" name="date_debut" class="form-control"
                                            placeholder="Définir la date de debut du devoir" value="{{ old("date_debut") }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date_fin" name="date_fin" class="form-control"
                                            placeholder="Entrez la date de la date fin du devoir" value="{{ old("date_fin") }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
