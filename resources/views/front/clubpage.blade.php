<x-front-layout>
    ...
    <section id="carouselExampleFade" class="carousel slide carousel-fade slider">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('storage/' . $currentClub->club_image) }}" class="d-block" alt="...">
                <div class="carousel-caption">
                    <h2> {{ $currentClub->club_name }} </h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <div id="carouselExampleIndicators" class="carousel slide slider" data-bs-ride="carousel">
        <div class="carousel-indicators">
            @foreach ($currentClub->sliders as $slider)
                            ...
                            <div class="featured-box">
                                <div class="feature-card">
                                    ...
                                    <img style="height: 300px;
                                        width: 100%;
                                        object-fit: cover;"
                                        src="{{ asset('storage/'.$club->club_image) }}"
                                    >
                                </div>
                                <div class="content">
                                    <h3 class="text-uppercase">
    ...
    <section class="bg-04">
        <div class="container">
            <div class="row">
               <div class="col-12">
                    <div class="heading">
                        <h2>Actualités du club {{ $currentClub->club_name }}</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                @if ($currentClub->actualites->isEmpty())
                ...
                @else
                    @foreach ($currentClub->actualites as $actualite)
