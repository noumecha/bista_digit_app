<x-front-layout>
    ...
    <section id="carouselExampleFade" class="carousel slide carousel-fade slider">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('storage/' . $booster->specialite_image) }}" class="d-block" alt="...">
                <div class="carousel-caption">
                    <h2> {{ $booster->specialite_title }} </h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <div id="carouselExampleIndicators" class="carousel slide slider" data-bs-ride="carousel">
        <div class="carousel-indicators">
            @foreach ($booster->sliders as $slider)
