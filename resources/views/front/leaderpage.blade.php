<x-front-layout>
    ...
    <section id="carouselExampleFade" class="carousel slide carousel-fade slider">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('storage/' .$leader->specialite_image) }}" class="d-block" alt="...">
                <div class="carousel-caption">
                    <h2> {{$leader->specialite_title }} </h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <div id="carouselExampleIndicators" class="carousel slide slider" data-bs-ride="carousel">
        <div class="carousel-indicators">
            @foreach ($leader->sliders as $slider)
    ...
    <section class="bg-04">
        <div class="container">
            <div class="row">
               <div class="col-12">
                    <div class="heading">
                        <h2>Actualités du pogramme {{$leader->specialite_title }}</h2>
                    </div>
                </div>
            </div>
            <div class="row">
