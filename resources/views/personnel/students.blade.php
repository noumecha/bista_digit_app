                        ...
                        <div class="pb-0 card-header">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 text-end">
                                    <a href="#studentform" class="btn btn-lg btn-dark btn-primary">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="pb-0 card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="">Ajouter un nouveau membre du student</h5>
                                </div>
                            </div>
                            <form  enctype="multipart/form-data" role="form" id="studentform" class="form row" method="POST" action="{{ route('student.store') }}">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                            placeholder="Entrez le nom du student" value="{{old("name")}}" aria-label="Name"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="surname" name="surname" class="form-control"
                                            placeholder="Entrez le prénom du student" value="{{old("surname")}}" aria-label="Name"
                                            aria-describedby="name-addon">
                                        @error('surname')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
