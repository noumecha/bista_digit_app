                ...
                <div class="col-12">
                    <div class="card">
                        <div class="pb-0 card-header">
                            ...
                            <form  enctype="multipart/form-data" role="form" id="personnelform" class="form row" method="POST" action="{{ route('personnel.store') }}">
                                @csrf
                                <!--div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="matricule" name="matricule" class="form-control"
                                            placeholder="Entrez l'adresse email" value="{ {old("matricule")}}">
                                        @ error('matricule')
