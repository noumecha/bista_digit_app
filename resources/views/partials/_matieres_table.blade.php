                ...
                <tr>
                    ...
                    <td class="text-center d-flex justify-content-center align-middle bg-transparent border-bottom" style="gap:10px;">
                        <a
                            ...
                            data-action="edit"
                            data-matiere-id = "{{ $mat->id }}"
                            data-url="{{ route('matiere.store', $mat->id) }}"
                        ...
                        <button
                            ...
                            data-bs-toggle="modal"
                            data-bs-target="#confirmDelete-{{ $mat->id }}">
                            <i class="fa-solid fa-trash"></i>
                        </button>
                        <!-- modal for delete confirmation -->
                        <div class="modal fade" id="confirmDelete-{{ $mat->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" >
                            <div class="modal-dialog">
                                <form role="form" class="form" method="POST" action="{{ route('matiere.destroy', $mat->id) }}">
                                    @csrf
                                    @method('DELETE')
