                ...
                <tr>
                    ...
                    <td class="text-center align-middle bg-transparent border-bottom">
                        <a
                            ...
                            data-action="edit"
                            data-boosterevaluation-id = "{{ $evaluation->id }}"
                            data-url="{{ route('booster.evaluationSave', $evaluation->id) }}"
                        ...
                        <div class="modal fade" id="confirmDelete-{{ $evaluation->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                            <div class="modal-dialog">
                                <form role="form" class="form" method="POST" action="{{ route('booster.evaluationDelete', $evaluation->id) }}">
                                    @csrf
                                    @method('DELETE')
