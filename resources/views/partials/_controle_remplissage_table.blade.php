                    ...
                    <td class="align-middle bg-transparent pt-0 border-bottom">
                        <div class="progress w-100" role="progressbar" aria-label="Animated striped example"
                            ...
                            <div class="progress-bar
                                @if ((int)getRemplissagePourcentage($trace->classe_id, $trace->matiere_id, $trace->evaluation_id) === 100)
                                    text-white text-bg-success
                                @elseif((int)getRemplissagePourcentage($trace->classe_id, $trace->matiere_id, $trace->evaluation_id) < 50)
                                ...
                                @endif
                                "
                                style="height: 12px; width: {{ getRemplissagePourcentage($trace->classe_id, $trace->matiere_id, $trace->evaluation_id) }}%">
                                {{ getRemplissagePourcentage($trace->classe_id, $trace->matiere_id, $trace->evaluation_id) }}%
                            </div>
                        </div>
                    </td>
                </tr>
