                ...
                <tr>
                    ...
                    <td class="text-center d-flex justify-content-center align-middle bg-transparent border-bottom" style="gap:10px;">
                        <a
                            ...
                            data-url="{{ route('actualite.store', $actualite->id) }}"
                        ...
                        <button
                            ...
                            data-bs-toggle="modal"
                            data-bs-target="#confirmDelete-{{ $actualite->id }}">
                            <i class="fa-solid fa-trash"></i>
                        </button>
                        <!-- modal for delete confirmation -->
                        <div class="modal fade" id="confirmDelete-{{ $actualite->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
