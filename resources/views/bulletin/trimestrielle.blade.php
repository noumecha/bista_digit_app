                ...
                <table border="2" class="w-100 h-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="p-2 border-2">[Trim X]</td>
            ...
            <div class="col-md-4 col-lg-4 d-flex flex-column">
                <table border="2" class="w-100 h-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-1 border-2" colspan="4">[Evaluation-1-trim-x]</td>
                            <td class="p-1 text-center fw-bold border-2" colspan="1">[moy-eval1-trim-x]</td>
                        </tr>
                        <tr>
                            <td class="p-1 border-2" colspan="4">[Evaluation-2-trim-x]</td>
                            <td class="p-1 text-center fw-bold border-2" colspan="1">[moy-eval2-trim-x]</td>
                        </tr>
                    </tbody>
                </table>
                <div class="d-flex flex-column">
                    <h5 class="text-center fw-bold">
                        Moyenne trimestrielle : [moy-trim-x]
                    </h5>
                    <h5 class="text-center fw-bold">
                        Rang trimmestrielle : [rang-trim-x]
                    </h5>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
